...
public class SolCalibracionFrutaDao implements ISolCalibracionFrutaDao {
    ...
    @Override
    public SolConCalibracionFrutaDto save(SolConCalibracionFrutaDto solCalibracionFruta) {
    ...
    private SolConCalibracionFrutaDto insert(SolConCalibracionFrutaDto solCalibracionFruta) {
    ...
    public SolConCalibracionFrutaDto update(SolConCalibracionFrutaDto solCalibracionFruta) {
        create.transaction(x -> {
