...
public class TabSolImagenRecord extends UpdatableRecordImpl<TabSolImagenRecord> implements Record21<Long, String, String, String, byte[], String, LocalDateTime, LocalDateTime, Integer, Integer, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long> {

    private static final long serialVersionUID = 837540406;
    ...
    @Override
    public Row21<Long, String, String, String, byte[], String, LocalDateTime, LocalDateTime, Integer, Integer, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long> valuesRow() {
    ...
    @Override
    public TabSolImagenRecord value17(Long value) {
        setIdSolControlPeso(value);
        return this;
    }

    @Override
    public TabSolImagenRecord value18(Long value) {
        setIdSolFinca(value);
        return this;
    }

    @Override
    public TabSolImagenRecord value19(Long value) {
        setIdSolConsolidadoGancho(value);
        return this;
    }

    @Override
    public TabSolImagenRecord value20(Long value) {
    ...
    @Override
    public TabSolImagenRecord values(Long value1, String value2, String value3, String value4, byte[] value5, String value6, LocalDateTime value7, LocalDateTime value8, Integer value9, Integer value10, Long value11, Long value12, Long value13, Long value14, Long value15, Long value16, Long value17, Long value18, Long value19, Long value20, Long value21) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TabSolImagenRecord(Long idSolImagen, String nombre, String descripcion, String seccion, byte[] imagen, String estado, LocalDateTime fechaIngreso, LocalDateTime fechaModifica, Integer usuarioIngreso, Integer usuarioModifica, Long idSolicitud, Long idSolContenedor, Long idSolSelloLlegada, Long idSolSelloInstalado, Long idSolTransportista, Long idSolProceso, Long idSolControlPeso, Long idSolFinca, Long idSolConsolidadoGancho, Long idSolCalidad, Long idSolCalPackingList) {
        super(TabSolImagen.TAB_SOL_IMAGEN);
        ...
        set(10, idSolicitud);
        set(11, idSolContenedor);
        set(12, idSolSelloLlegada);
        set(13, idSolSelloInstalado);
        set(14, idSolTransportista);
        set(15, idSolProceso);
        set(16, idSolControlPeso);
        set(17, idSolFinca);
        set(18, idSolConsolidadoGancho);
        set(19, idSolCalidad);
        set(20, idSolCalPackingList);
    }
}
